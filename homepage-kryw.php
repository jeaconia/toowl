...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="container mx-auto p-2 text-center" style="width: 800px;">
      <a href="database-kiloan.php" class="btn btn-primary btn-lg">Laundry Kiloan</a></br></br>
      <a href="database-satuan.php" class="btn btn-primary btn-lg">Laundry Satuan</a></br></br>
      <a href="database-sepatu.php" class="btn btn-primary btn-lg">Laundry Sepatu</a>
    </div> </br> </br>
