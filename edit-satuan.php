...
$sql="SELECT * FROM tb_pelanggan_satuan WHERE id_pelanggan='$id_pelanggan'";
...
if(isset($_POST['submit'])) { 
    ...
    $sql="UPDATE tb_pelanggan_satuan SET id_pelanggan='$id_pelanggan', nama_pelanggan='$nama_pelanggan', hp_pelanggan='$hp_pelanggan',
